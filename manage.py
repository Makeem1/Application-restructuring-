...
def make_shell_context():
    return dict(app=app, User=User, Coupon=Coupon, Invoice=Invoice, Subscription=Subscription, CreditCard=CreditCard, db=db, create_plan=create_plan, delete_plan=delete_plan, list_plan = list_plan )
